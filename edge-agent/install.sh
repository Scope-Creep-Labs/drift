...
#
# Bricking safeguard: the agent has a hard-coded blocklist of critical
# service/container names (drift-agent, drift-postgres, etc.) that it
# will refuse to deploy. See PROTECTED_NAMES in agent.sh.
